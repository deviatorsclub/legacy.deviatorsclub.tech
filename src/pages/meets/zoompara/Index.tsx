...
export default function Index() {
  ...
  const createScale = (baseScale: number) =>
    useTransform(scrollYProgress, [0, 1], [1, getScaleFactor(baseScale)]);
  ...
  const pictures: Picture[] = [
    ...
    { src: Picture5, alt: "Tanmay", scale: createScale(13) },
    ...
    { src: Picture14, alt: "Vivek", scale: createScale(16) },
    { src: Picture15, alt: "Kunal", scale: createScale(16) },
